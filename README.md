...
- The client checks GitHub Releases in the source repository automatically on startup and every 30 minutes, then downloads and offers to restart into a newer build.
